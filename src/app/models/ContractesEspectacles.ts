...
export class ContractesComercialsFields {
  cte_idContracteEspectacle = new NumberType();
  cte_idcontracte = new NumberType();
  cte_idespectacle = new NumberType();
  cte_idEspai = new NumberType();
  cte_PreuSC = new NumberType();
  cte_IVASC = new NumberType();
  cte_PreuAC = new NumberType();
  cte_IVAAC = new NumberType();
  cte_TotalSC = new NumberType();
  cte_TotalAC = new NumberType();
}
