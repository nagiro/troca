...
export class EspaiFields {
  ...
  es_Poblacio = new TextType(new FieldConfig('es_Poblacio', 'Població', 'Input', true, 2 ) );
  es_Adreca = new TextType(new FieldConfig('es_Adreca', 'Adreça', 'Input', true, 5 ) );
  ...
  es_TeCarregaDescarrega = new BooleanType(new FieldConfig('es_TeCarregaDescarrega', 'Té càrrega/descàrrega', 'Select', true, 3 ) );
  es_Lloc_canviarse = new BooleanType(new FieldConfig('es_Lloc_canviarse', 'LLoc on canviar-se', 'Select', true, 3 ) );
  es_Responsable_nom = new TextType(new FieldConfig('es_Responsable_nom', 'Nom Responsable', 'Input', true, 2 ) );
  es_Responsable_mobil = new TextType(new FieldConfig('es_Responsable_mobil', 'Mòbil Resp.', 'Input', true, 2 ) );
  es_Responsable_email = new TextType(new FieldConfig('es_Responsable_mobil', 'Email Resp.', 'Input', true, 2 ) );
  es_Responsable1_nom = new TextType(new FieldConfig('es_Responsable_nom', 'Nom Responsable 2', 'Input', true, 2 ) );
  es_Responsable1_mobil = new TextType(new FieldConfig('es_Responsable_mobil', 'Mòbil Resp. 2', 'Input', true, 2 ) );
  es_Responsable1_email = new TextType(new FieldConfig('es_Responsable_mobil', 'Email Resp. 2', 'Input', true, 2 ) );
